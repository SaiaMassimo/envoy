...
class MementoIntegrationTest : public testing::TestWithParam<Network::Address::IpVersion>,
                               public HttpIntegrationTest {
public:
  MementoIntegrationTest() : HttpIntegrationTest(Http::CodecType::HTTP1, GetParam()) {
    setUpstreamCount(3);
...
INSTANTIATE_TEST_SUITE_P(IpVersions, MementoIntegrationTest,
                         testing::ValuesIn(TestEnvironment::getIpVersionsForTest()),
                         TestUtility::ipTestParamsToString);

TEST_P(MementoIntegrationTest, NormalLoadBalancing) {
  initializeConfig();
